...
exports.JSONRPCServer = exports.createMethodNotFoundResponse = exports.createInvalidRequestResponse = void 0;
...
exports.createInvalidRequestResponse = createInvalidRequestResponse;
...
var JSONRPCServer = /** @class */ (function () {
    function JSONRPCServer(options) {
        ...
        this.handleMethodNotFound = defaultHandleMethodNotFound;
                ...
                switch (_a.label) {
                    case 0:
                        if (requests.length === 0) {
                            return [2 /*return*/, (0, models_1.createJSONRPCErrorResponse)(null, models_1.JSONRPCErrorCode.InvalidRequest, "Invalid Request")];
                        }
                        return [4 /*yield*/, Promise.all(requests.map(function (request) { return _this.receiveSingle(request, serverParams); }))];
                    case 1:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [2 /*return*/, (0, exports.createInvalidRequestResponse)(request)];
    ...
    JSONRPCServer.prototype.callMethod = function (method, request, serverParams) {
        ...
        var callMethod = function (request, serverParams) {
            if (method) {
                ...
                return _this.handleMethodNotFound(request, serverParams);
            }
        };
...
var defaultHandleMethodNotFound = function (request) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        if (request.id !== undefined) {
            return [2 /*return*/, (0, exports.createMethodNotFoundResponse)(request.id)];
        }
        else {
            return [2 /*return*/, null];
        }
