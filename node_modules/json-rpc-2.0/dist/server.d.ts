...
export declare const createInvalidRequestResponse: (request: any) => JSONRPCResponse;
export declare const createMethodNotFoundResponse: (id: JSONRPCID) => JSONRPCResponse;
...
export declare class JSONRPCServer<ServerParams = void> {
    ...
    handleMethodNotFound: <ServerParams = void>(request: JSONRPCRequest, serverParams: ServerParams) => Promise<JSONRPCResponse | null>;
